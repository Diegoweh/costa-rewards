...
export default function BookingBar({
  ...
  return (
    <div
      ...
      rounded-md bg-[rgba(224,234,241,0.75)] backdrop-blur 
      text-[#023a50] shadow-lg border border-white/10 ${className}`}
    >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="relative">
              <input
                ...
                border-[#d79200]/60 focus:border-[#d79200] pb-1 text-[#023a50]"
              />
            </div>
            <div className="relative">
              <input
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              border-[#d79200]/60 focus:border-[#d79200] pb-1 pr-6 text-[#023a50]"
            >
